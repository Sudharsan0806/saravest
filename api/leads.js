export default async function handler(req, res) {
  ...
  try {
    ...
    const SUPABASE_URL = process.env.SUPABASE_URL || 'https://ozmvemetjpohyirfqyji.supabase.co';
    ...
    const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im96bXZlbWV0anBvaHlpcmZxeWppIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc4NjUzMDIxMCwiZXhwIjoyMTAyMTA2MjEwfQ.cgCCCCOjHyvo36Rw02YEN8ZkV7h2Hca1WVP92J52sas';
